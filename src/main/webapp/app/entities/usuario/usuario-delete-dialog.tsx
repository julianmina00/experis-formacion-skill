...
export const UsuarioDeleteDialog = (props: IUsuarioDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="experisFormacionApp.usuario.delete.question">
        <Translate contentKey="experisFormacionApp.usuario.delete.question" interpolate={{ id: usuarioEntity.id }}>
